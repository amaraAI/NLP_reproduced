...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    for i in examples: 
        print('*******************')
        print(f'the guid is {i.guid}')
        print(f'the text  is {i.text_a}')
        print(f'the text b is {i.text_b}')
        print(f'the label is {i.label}')
        print('*******************')
    #print("here is the example" , examples)
    '''
    ...
    if output_mode == "classification":
        ...
        #print(f'This is the all labels id ',all_label_ids )
...
def main():
    ...
    s_config = AutoConfig.from_pretrained("google/bert_uncased_L-6_H-768_A-12")
    s_config.num_hidden_layers = args.num_hidden_layers
    s_config.num_labels = num_labels
    s_config.finetuning_task = args.task_name
    s_config.output_hidden_states = True
    s_model = AutoModelForSequenceClassification.from_pretrained("google/bert_uncased_L-6_H-768_A-12", config=s_config)
